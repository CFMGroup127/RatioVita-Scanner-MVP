"""
Reschedule Executive Strategy Group Meeting to 4:15 PM EST Today
This script creates/updates the meeting for November 17, 2025 at 4:15 PM EST on the Project Schedule Calendar.
"""
import os
...
def reschedule_meeting_415pm():
    """
    Reschedule Executive Strategy Group Meeting to 4:15 PM EST today (November 17, 2025) on Project Schedule Calendar.
    """
    print("\n" + "="*80)
    print("📅 RESCHEDULING MEETING TO 4:15 PM EST TODAY")
    print("="*80)
    print("Meeting: Executive Strategy Group Meeting - V1 Legacy Review & V2 Planning")
    print("Date: Monday, November 17, 2025")
    print("Time: 4:15 PM EST - 6:15 PM EST")
    ...
    # Meeting details - 4:15 PM EST
    meeting_date = "2025-11-17"
    start_time = "16:15:00"  # 4:15 PM EST
    end_time = "18:15:00"    # 6:15 PM EST
    
    task_description = f"""
**TASK: Reschedule Executive Strategy Group Meeting to 4:15 PM EST Today on Project Schedule Calendar**
...
- Start Time: 4:15 PM EST (16:15)
- End Time: 6:15 PM EST (18:15)
- Duration: 2 hours
...
- start_time: "2025-11-17T16:15:00" (4:15 PM EST)
- end_time: "2025-11-17T18:15:00" (6:15 PM EST)
...
1. Use the **GMailTool** to send meeting invitations to ALL 15 team members:
   - Recipients: {', '.join(agent_emails[:5])} and 10 others (all 15 agents individually listed)
   - CC: collin.m@ratiovita.com (MANDATORY)
   - Subject: "Meeting Invitation: Executive Strategy Group Meeting - TODAY 4:15 PM EST"
   - Body: "You are invited to the Executive Strategy Group Meeting scheduled for TODAY, Monday, November 17, 2025, from 4:15 PM EST to 6:15 PM EST. The meeting will be held on the RatioVitaAi Project Schedule Calendar. All pre-read materials remain valid. Please acknowledge receipt of this invitation per P8 protocol by logging 'MEETING ACCEPTED: Executive Strategy Group Meeting - November 17, 2025, 4:15 PM EST' in your memory document. Per P9 protocol, all times are in Eastern Standard Time (EST)."
   
   **MANDATORY:** This email invitation enforces the P8 Meeting Acceptance Acknowledgment protocol. All 15 agents must receive this invitation.
   
2. Update your memory document with:
   - "Meeting Rescheduled: Executive Strategy Group Meeting - November 17, 2025, 4:15 PM EST - 6:15 PM EST"
...
"""
    ...
    task = Task(
        ...
        agent=dana_agent,
        expected_output="Calendar event created/updated on project schedule calendar for 4:15 PM EST today, meeting invitations sent to all 15 team members, memory updated with confirmation (all times in EST)."
    )
    ...
    # Execute
    print("\n" + "="*80)
    print("Starting meeting reschedule to 4:15 PM EST...")
    print("="*80)
    
    try:
        result = crew.kickoff()
        print("\n" + "="*80)
        print("✅ MEETING RESCHEDULE TO 4:15 PM EST COMPLETE")
        print("="*80)
        print(f"\n📊 Results:\n{result}")
        return result
    except Exception as e:
