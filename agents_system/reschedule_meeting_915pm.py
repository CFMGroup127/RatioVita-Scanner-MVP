"""
Reschedule Executive Strategy Group Meeting to 9:15 PM EST Today
This script creates/updates the meeting for November 17, 2025 at 9:15 PM EST on the Project Schedule Calendar.
"""
import os
...
def reschedule_meeting_915pm():
    """
    Reschedule Executive Strategy Group Meeting to 9:15 PM EST today (November 17, 2025) on Project Schedule Calendar.
    """
    print("\n" + "="*80)
    print("📅 RESCHEDULING MEETING TO 9:15 PM EST TODAY")
    print("="*80)
    print("Meeting: Executive Strategy Group Meeting - V1 Legacy Review & V2 Planning")
    print("Date: Monday, November 17, 2025")
    print("Time: 9:15 PM EST - 11:15 PM EST")
    ...
    # Meeting details - 9:15 PM EST
    meeting_date = "2025-11-17"
    start_time = "21:15:00"  # 9:15 PM EST
    end_time = "23:15:00"    # 11:15 PM EST
    
    task_description = f"""
**TASK: Reschedule Executive Strategy Group Meeting to 9:15 PM EST Today on Project Schedule Calendar**
...
- Start Time: 9:15 PM EST (21:15)
- End Time: 11:15 PM EST (23:15)
- Duration: 2 hours
...
- start_time: "2025-11-17T21:15:00" (9:15 PM EST)
- end_time: "2025-11-17T23:15:00" (11:15 PM EST)
...
1. Use the **GMailTool** to send meeting invitations to ALL 15 team members:
   ...
   - Subject: "Meeting Invitation: Executive Strategy Group Meeting - TODAY 9:15 PM EST"
   - Body: "You are invited to the Executive Strategy Group Meeting scheduled for TODAY, Monday, November 17, 2025, from 9:15 PM EST to 11:15 PM EST. The meeting will be held on the RatioVitaAi Project Schedule Calendar. All pre-read materials remain valid. Please acknowledge receipt of this invitation per P8 protocol by logging 'MEETING ACCEPTED: Executive Strategy Group Meeting - November 17, 2025, 9:15 PM EST' in your memory document. Per P9 protocol, all times are in Eastern Standard Time (EST)."
...
2. Update your memory document with:
   - "Meeting Rescheduled: Executive Strategy Group Meeting - November 17, 2025, 9:15 PM EST - 11:15 PM EST"
...
"""
    ...
    task = Task(
        ...
        agent=dana_agent,
        expected_output="Calendar event created/updated on project schedule calendar for 9:15 PM EST today, meeting invitations sent to all 15 team members, memory updated with confirmation (all times in EST)."
    )
    ...
    # Execute
    print("\n" + "="*80)
    print("Starting meeting reschedule to 9:15 PM EST...")
    print("="*80)
    
    try:
        result = crew.kickoff()
        print("\n" + "="*80)
        print("✅ MEETING RESCHEDULE TO 9:15 PM EST COMPLETE")
        print("="*80)
        print(f"\n📊 Results:\n{result}")
        return result
    except Exception as e:
